...
import Domain.ServiceLayer.Objects.Category;
import Domain.ServiceLayer.Objects.Product;
...
//                printUpcomingShifts();
    ...
    public void listProducts() {
        Result<List<Domain.ServiceLayer.Objects.Product>> r = controller.getProducts();
        if (r.isError())
            System.out.println(r.getError());
        else {
            List<Domain.ServiceLayer.Objects.Product> productList = r.getValue();
            for (Domain.ServiceLayer.Objects.Product p : productList)
