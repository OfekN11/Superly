...
public abstract class DAO {
    private static String dbName= "Superly.db"; // need to be change!
    ...
    public static void setDBPathForTests(Class testClass) {
        //create and delete db?
        url=String.format("jdbc:sqlite:Test/SuperlyTests%s.db", testClass.toString());
    }
