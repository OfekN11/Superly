...
public class WebMain {
    ...
    public static final Map<Class<? extends Servlet>, String> servletToPath= Stream.of(
            ...
            new AbstractMap.SimpleEntry<>(CashRegister.class, "/ManageInventory/CashRegister"),
            new AbstractMap.SimpleEntry<>(TransportArrived.class, "/ManageInventory/TransportArrived"),
            new AbstractMap.SimpleEntry<>(Products.class, "/ManageInventory/StockReport"),
            new AbstractMap.SimpleEntry<>(StockReport.class, "/Products"),
