...
public class DEmployeeShiftController extends DalController<Pair<Pair<Date,ShiftTypes>,Set<Integer>>> {
    ...
    @Override
    public Set<Pair<Pair<Date, ShiftTypes>, Set<Integer>>> loadData() {
        try {
            Set<Pair<Pair<Date, ShiftTypes>, Set<Integer>>> shiftEmployee = new HashSet<>();
